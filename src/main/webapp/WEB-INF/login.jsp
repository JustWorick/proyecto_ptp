			...
			<div class="col-lg-5 d-flex flex-column justify-content-around">
				<div class="px-lg-5 pt-lg-4 pb-lg-3 p-4 mb-0">
					<img src="/public/img/logo.png"
						alt="logoLife" class="img- mb-0" width="100px" />
					<!--Cambiar Logo-->
				</div>
				<div class="px-lg-5 py-lg-4 p-4">
					...
					<form class="mb-5" action="/login" method="post">
						<div class="mb-4">
							...
							<input type="email" class="form-control bg-dark-x border-0" name="email"
								placeholder="Ingresa tu email" id="exampleInputEmail1"
								aria-describedby="emailHelp"/>
						</div>
						<div class="mb-4">
							<label for="exampleInputPassword1" class="form-label fw-bold">Contraseña</label>
							<input type="password" class="form-control bg-dark-x border-0 mb-2" name="password"
					...
					<p class="fw-bold text-center text-muted mb-3">O inicia sesion
						con</p>
				...
				<div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4">
					...
					<a href="/registro" class="text-light fw-bold text-decoration-none"> Crea tu cuenta</a>
				</div>
			</div>
		</div>
	</section>
